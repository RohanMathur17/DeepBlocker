...
class DeepBlocker:
    ...
    def block_datasets_bert(self, left_df, right_df, cols_to_block):
        ...
        left_tuple_embedding = do_bert_embeddings(self.left_df,"_merged_text")
      
        print("Obtaining tuple embeddings for right table")
        right_tuple_embedding = do_bert_embeddings(self.right_df,"_merged_text")
    ...
    def block_datasets(self, left_df, right_df, cols_to_block):
        ...
        topK_neighbors = query_embeddings_in_batches(self.vector_pairing_model, self.left_tuple_embeddings, 1000)
