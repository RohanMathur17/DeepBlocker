...
itunes_amazon_cols_to_block = ["Song_Name","Artist_Name","Price",
                              "Genre","Time"]
left_df = pd.read_csv("Datasets/Structured/iTunes-Amazon-1/tableA.csv", encoding='latin1')
right_df = pd.read_csv("Datasets/Structured/iTunes-Amazon-1/tableB.csv", encoding='latin1')
...
candidate_set_df = db.block_datasets(left_df, right_df,itunes_amazon_cols_to_block )
golden_df = pd.read_csv("Datasets/Structured/iTunes-Amazon-1/test.csv", encoding='latin1')
