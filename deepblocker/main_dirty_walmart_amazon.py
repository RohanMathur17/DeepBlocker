...
walmart_amazon_cols_to_block = ['title','category','brand','modelno','price']

left_df = pd.read_csv("Datasets/Dirty/Walmart-Amazon-2/tableA.csv", encoding='latin1')
right_df = pd.read_csv("Datasets/Dirty/Walmart-Amazon-2/tableB.csv", encoding='latin1')
...
candidate_set_df = db.block_datasets(left_df, right_df,walmart_amazon_cols_to_block )
golden_df = pd.read_csv("Datasets/Dirty/Walmart-Amazon-2/test.csv", encoding='latin1')
