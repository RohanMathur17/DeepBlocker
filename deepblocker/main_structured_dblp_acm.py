...
dblp_acm_cols_to_block = ['title','authors','venue','year']

left_df = pd.read_csv("Datasets/Structured/DBLP-ACM-1/tableA.csv", encoding='latin1')
right_df = pd.read_csv("Datasets/Structured/DBLP-ACM-1/tableB.csv", encoding='latin1')
...
candidate_set_df = db.block_datasets(left_df, right_df, dblp_acm_cols_to_block)
golden_df = pd.read_csv("Datasets/Structured/DBLP-ACM-1/test.csv", encoding='latin1')
